...
select case lcase(action)
	...
	case "download"
		Dim xDest, xClusions, xCopy, xResult, OptimiseIsChecked, PublishResult
		
		OptimiseIsChecked = (Request("OptimiseIsChecked") = "1")
		PublishResult = (Request("Publish") = "1")
		...
		if PublishResult then
			Response.Redirect "/app/download/publish/" & fnUtils_Base64Encode(Server.UrlEncode(strTempFolder & "/" & zipName))
			Response.End
