...
<% end if %>
        ...
        <header class="jumbotron subhead" id="overview">
            <div class="container-fluid">
				...
				<% ElseIf CURRENT_PAGE = "edit" Then %>
					  <a href="/engine/action.asp?ID=<%=COURSE_ID%>&action=download&OptimiseIsChecked=1&Publish=1" class="btn btn-inverse" title="Download" data-optimise target="download"><i class='icon-upload icon-3x'></i><br/><small>Publish</small></a>
					  <a href="/engine/action.asp?ID=<%=COURSE_ID%>&action=download&OptimiseIsChecked=1" class="btn btn-inverse" title="Download" data-optimise target="download"><i class='icon-download icon-3x'></i><br/><small>Zip</small></a>
					  ...
					  <a href="/" class="btn btn-inverse" title="Close editor"><i class='icon-power-off icon-3x'></i><br/><small>Close</small></a><br />
