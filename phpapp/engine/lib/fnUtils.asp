...
Function fnUtils_Base64Encode(sText)
    Dim oXML, oNode
...
Function fnUtils_Base64Decode(ByVal vCode)
    Dim oXML, oNode
...
Function fnUtils_Base32Encode(ByVal lInput)
    Dim lModulo, sTemp
    Do Until lInput = 0
        lModulo = lInput Mod 32
        sTemp = Mid("0123456789abcdefghjkmnpqrstvwxyz", lModulo + 1, 1) & sTemp
        lInput = lInput \ 32
    Loop
    ToBase32 = sTemp
End Function

Function fnUtils_Base32Decode(ByVal sInput)
    ...
    For i = lLen To 1 Step -1
        sR = Mid(sTemp, i, 1)
        iY = InStr(1, "0123456789abcdefghjkmnpqrstvwxyz", sR, vbTextCompare) - 1
