...
if (isset($this->sheets)) foreach ($this->sheets as $file) echo "<link rel='stylesheet' type='text/css' href='{$file}'>", PHP_EOL;
if (isset($this->headjs)) foreach ($this->headjs as $script) echo "<script type='text/javascript' src='{$script}'></script>", PHP_EOL;
