			...
			"group": [
				{
					...
					"commands": [
						{"text":"right-hand images" , "command":"{rightimages %images%}", "icon":"icon-picture"},
						{"text":"single image" , "command":"{image %image%}",  "icon":"icon-camera"},
			...
			"group": [
				...
				},
				{
					...
					"commands": [
						...
						{"text":"setscore", "command":"{setscore 10}"}
					]
				}
			]
		},
