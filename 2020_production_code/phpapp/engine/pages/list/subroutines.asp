...
Dim ar, i, j, dft_val
	dft_val = ""
	ar = Split("box-shadow,box-none,rp-bouncein,rp-fadein,rp-fadeinfast,rp-blindin,rp-slidein,pull-left,pull-right,scale-image,play-button",",")
	j = ubound(ar)
...
Sub RenderJsonEditor()
	response.write "<table id='json'><tr><th>Accessibility</th></tr>"
	response.write "<tr><td><a href='/app/media/captions/" & request.querystring("id") & "/view/' onclick='var w=window.open(this.href,""json"",""scrolling=1,scrollbars=1,resizable=1,width=1024,height=768"");w.focus();return false;'>Tags and Captions</a></td></tr>"
	response.write "</table>"
End Sub
%>