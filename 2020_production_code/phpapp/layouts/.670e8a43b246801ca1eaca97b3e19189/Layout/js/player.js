...
function LoadContent(nID, avoidHistory) {
	...
	var fileName = getPageOptimisedFileName(nID); // .getPageHtmlFileName(nID);
	...
	$("#loading-animation").fadeIn(100, function () {
      	...
      	$content.attr("class", "ui-layout-center " + sClassName);
...
function updatePageStatus(nPageId, sTestStatus, nTestScore, bScored) {
	// console.log("updatePageStatus", nPageId, sTestStatus, nTestScore, bScored);
